...
namespace BusinessLayer
{
    public static class DataLoader
    {
        public static void generateData()
        {
            ...
            {
                new ZadostDTO(1, 4, DTO.Enums.TypZadosti.PRODLOUZENI, DateTime.Now.AddDays(15)),
                new ZadostDTO(2, 13, DTO.Enums.TypZadosti.PRODLOUZENI, DateTime.Now.AddDays(8)),
                new ZadostDTO(3, 14, DTO.Enums.TypZadosti.ZRUSENI, DateTime.Now.AddDays(-15)),
                new ZadostDTO(4, 19, DTO.Enums.TypZadosti.ZRUSENI, DateTime.Now.AddDays(15)),
                new ZadostDTO(5, 20, DTO.Enums.TypZadosti.PRODLOUZENI, DateTime.Now),
            ...
            List<TreninkDTO> treninky = new List<TreninkDTO>
            {
                ...
                new TreninkDTO(4, 1, "Trenink D", new List<int> { 3, 4, 13, 18 }),
                new TreninkDTO(5, 1, "Trenink E", new List<int> { 3, 12, 19, 28 }),
                new TreninkDTO(6, 1, "Trenink F", new List<int> { 1, 2, 7, 25 }),
